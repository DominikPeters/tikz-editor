...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `core-baseline` | 1,279 | 397 | 31.0% | 791 | 91 | 0 |
...
- Unsupported AMS/package control-sequence atoms and macros beyond the first vendored AMS font slice, such as `\iiiint`, `\ddddot`, `\mathbbm`, `\boldsymbol`, and package commands like `\bra`.
