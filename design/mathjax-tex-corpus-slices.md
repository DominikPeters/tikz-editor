...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `core-baseline` | 1,279 | 420 | 32.8% | 768 | 91 | 0 |
...
- Unsupported AMS/package control-sequence atoms and macros beyond the first vendored AMS font/operator slices, such as `\DeclareMathOperator`, `\mathbbm`, `\boldsymbol`, and package commands like `\bra`.
