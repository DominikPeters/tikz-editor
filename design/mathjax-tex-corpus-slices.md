...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `core-baseline` | 1,279 | 418 | 32.7% | 770 | 91 | 0 |
...
- Unsupported AMS/package control-sequence atoms and macros beyond the first vendored AMS font/operator slices, such as `\DeclareMathOperator`, `\subarray`, `\mathbbm`, `\boldsymbol`, and package commands like `\bra`.
