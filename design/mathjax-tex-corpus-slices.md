...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `core-baseline` | 1,279 | 416 | 32.5% | 772 | 91 | 0 |
...
- Unsupported AMS/package control-sequence atoms and macros beyond the first vendored AMS font/operator slices, such as `\genfrac`, `\mathbbm`, `\boldsymbol`, and package commands like `\bra`.
