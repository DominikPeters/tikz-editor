...
const DEFAULT_FONTS = ["cmr10", "cmbx10", "cmti10", "cmtt10", "cmss10"];
...
export const COMPUTER_MODERN_OT1_FONTS = ${JSON.stringify(fonts, null, 2)} as const satisfies GeneratedTexFontTable;
`;
